...
int main() {
  ...
  auto train_y = MNISTLoader::loadLabels<Scalar>("../tests/fashion-mnist/train-labels-idx1-ubyte", n_train);
  auto test_x = MNISTLoader::loadImages<Scalar>("../tests/fashion-mnist/t10k-images-idx3-ubyte", n_test);
  auto test_y = MNISTLoader::loadLabels<Scalar>("../tests/fashion-mnist/t10k-labels-idx1-ubyte", n_test);
